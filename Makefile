...
lib/liboptimml.so: build/eig.o build/nnls.o build/lstsq.o build/functions.o build/brent.o build/multivar.o
	$(CCOMP) $(IFLAGS) $(LFLAGS) -shared -o lib/liboptimml.so build/eig.o build/nnls.o build/lstsq.o build/functions.o build/brent.o build/multivar.o -lstdc++ -llapack

lib/liboptimml.a: build/eig.o build/nnls.o build/lstsq.o build/functions.o build/brent.o build/multivar.o 
	ar rcs lib/liboptimml.a build/eig.o build/nnls.o build/lstsq.o build/functions.o build/brent.o build/multivar.o 
